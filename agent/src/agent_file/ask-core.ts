// import { createChatModel } from "./lc_model";
...
// //structured output =  https://docs.langchain.com/oss/javascript/integrations/chat/openai#structured-output {openai // gemini // groq }